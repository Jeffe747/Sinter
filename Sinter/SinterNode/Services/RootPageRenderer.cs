...
public sealed class RootPageRenderer : IRootPageRenderer
{
    public string Render(NodeDashboard dashboard)
    {
        ...
        builder.AppendLine(":root{color-scheme:light;--bg:#f4f1ea;--panel:#fffdf9;--panel-strong:#fff;--ink:#122033;--muted:#5d6b7c;--line:#d8ddd4;--line-strong:#c5cdc0;--accent:#0f766e;--accent-soft:#d9f2ee;--warn:#b45309;--warn-soft:#fff2df;--code:#0f172a;--success:#166534;--success-soft:#e8f7ec;--shadow:0 14px 32px rgba(18,32,51,.07);}*{box-sizing:border-box;}html{scroll-behavior:smooth;}body{margin:0;background:radial-gradient(circle at top left,#faf6ef 0,#f4f1ea 45%,#ece9e0 100%);color:var(--ink);font-family:Bahnschrift,\"Segoe UI Variable\",\"Segoe UI\",Helvetica,Arial,sans-serif;line-height:1.38;}a{color:inherit;}main{max-width:1180px;margin:0 auto;padding:18px 16px 36px;}section{background:var(--panel);border:1px solid var(--line);border-radius:16px;padding:16px;margin-top:12px;box-shadow:var(--shadow);}header.hero{display:grid;grid-template-columns:1.5fr .9fr;gap:12px;align-items:stretch;}@media (max-width:900px){header.hero{grid-template-columns:1fr;}}h1{font-size:clamp(1.45rem,2.4vw,2.1rem);line-height:1.02;margin:0 0 6px;}h2{font-size:1rem;margin:0 0 8px;}p{margin:0 0 8px;}small,.muted{color:var(--muted);}code,pre,.mono{font-family:Consolas,\"Cascadia Code\",monospace;}table{width:100%;border-collapse:collapse;font-size:.93rem;}caption{text-align:left;font-weight:700;margin-bottom:8px;}th,td{text-align:left;padding:9px 10px;border-bottom:1px solid var(--line);vertical-align:top;}th{font-size:.77rem;text-transform:uppercase;letter-spacing:.04em;color:var(--muted);}tr:last-child td{border-bottom:0;}textarea,input{width:100%;padding:10px 12px;border-radius:10px;border:1px solid var(--line-strong);background:var(--panel-strong);color:var(--ink);font:inherit;}textarea:focus,input:focus,button:focus,.skip-link:focus{outline:3px solid rgba(15,118,110,.2);outline-offset:2px;border-color:var(--accent);}button{padding:10px 16px;border:0;border-radius:10px;background:var(--accent);color:#fff;font-weight:700;font:inherit;cursor:pointer;}button:hover{filter:brightness(.96);}dl.meta{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:10px;margin:0;}dl.meta div{padding:11px 12px;border:1px solid var(--line);border-radius:12px;background:var(--panel-strong);}dt{font-size:.74rem;text-transform:uppercase;letter-spacing:.05em;color:var(--muted);margin-bottom:4px;}dd{margin:0;font-size:.96rem;font-weight:600;word-break:break-word;} .skip-link{position:absolute;left:12px;top:12px;transform:translateY(-160%);background:var(--ink);color:#fff;padding:10px 12px;border-radius:10px;text-decoration:none;z-index:10;} .skip-link:focus{transform:translateY(0);} .hero-card{background:linear-gradient(180deg,#fffdf9 0,#f8f5ef 100%);border:1px solid var(--line);border-radius:16px;padding:16px;} .summary-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-top:10px;}@media (max-width:900px){.summary-grid{grid-template-columns:repeat(2,minmax(0,1fr));}}@media (max-width:560px){.summary-grid{grid-template-columns:1fr;}} .stat{padding:12px;border-radius:12px;border:1px solid var(--line);background:var(--panel-strong);} .stat-label{display:block;font-size:.72rem;text-transform:uppercase;letter-spacing:.05em;color:var(--muted);margin-bottom:4px;} .stat-value{display:block;font-size:1.28rem;font-weight:700;line-height:1.05;} .stat-note{display:block;font-size:.82rem;color:var(--muted);margin-top:4px;} .status-pill,.pill{display:inline-flex;align-items:center;gap:6px;padding:5px 9px;border-radius:999px;font-size:.8rem;font-weight:700;border:1px solid transparent;} .pill{background:#edf2f7;color:#243446;border-color:#d6dde6;margin:0 6px 6px 0;} .status-ready{background:var(--success-soft);color:var(--success);border-color:#b9e3c3;} .status-warn{background:var(--warn-soft);color:var(--warn);border-color:#f3cf95;} .key-box{background:var(--code);color:#f8fafc;padding:12px 14px;border-radius:12px;overflow:auto;} .section-head{display:flex;justify-content:space-between;gap:10px;align-items:flex-start;margin-bottom:8px;}@media (max-width:720px){.section-head{flex-direction:column;}} .stack{display:grid;gap:10px;} .compact{font-size:.88rem;} .table-wrap{overflow:auto;border:1px solid var(--line);border-radius:12px;background:var(--panel-strong);} .path{font-size:.8rem;color:var(--muted);word-break:break-all;margin-top:2px;} .warn-list{margin:4px 0 0;padding-left:18px;color:var(--warn);font-size:.8rem;} .empty{padding:12px;border:1px dashed var(--line-strong);border-radius:12px;color:var(--muted);background:#fbfaf7;} .form-grid{display:grid;grid-template-columns:1.1fr .9fr;gap:10px;align-items:start;}@media (max-width:900px){.form-grid{grid-template-columns:1fr;}} .help{font-size:.82rem;color:var(--muted);margin-top:4px;} .topline{display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin-bottom:8px;} .sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0;} </style></head><body>");
